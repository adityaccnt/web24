...
Route::middleware('auth')->group(function () {
    ...
    // if (session::has('app')) {
    Route::get('/kelola-nilai-excel/excel/{rombel}', [LearningController::class, 'export_excel']);
    Route::post('/kelola-nilai-excel/excel/import', [LearningController::class, 'import']);
    ...
    Route::resource('/kelola-nilai/{rombel}', ScoreController::class)->where('rombel','!excel');
    // }
