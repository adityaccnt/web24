                        ...
                        <div class="swiper-slide h-auto">
                            ...
                            <div class="feedback bg-white rounded-4 h-100">
                                ...
                                <div class="feedback-header d-flex align-items-center mb-35">
                                    <div class="flex-shrink-0"><img class="rounded-circle" loading="lazy" src="assets/img/root/testimoni-23-g.jpg" alt="" height="64" width="64"></div>
                                    <div class="flex-grow-1 ms-20">
                                        <h6 class="feedback-author mb-5 text-truncate">Grace Andriana Pit</h6>
                                        <p class="feedback-position text-gray-dark font-size-14 m-0 text-truncate">2023 &ndash; Univ. Negeri Semarang</p>
                                        <p class="feedback-position text-gray-dark font-size-14 m-0 text-truncate">Pendidikan Bahasa Prancis</p>
                                    </div>
                                </div>
                                <p class="feedback-text fw-medium text-dark m-0">“ Bagi angkatan saya yang sempat menjalani pembelajaran daring akibat pandemi, kisah kami mungkin begitu singkat di SMAN 24 Jakarta. Namun, tentu saja rindu kami tetap melekat. Setiap kegiatan terasa menyenangkan bersama guru, staff, dan teman-teman. Lingkungan sekolah yang kondusif dan suportif membuat kami semua semangat meraih cita-cita dan mengincar perguruan tinggi impian kami. Semangat generasi penerus bangsa, semakin maju SMAN 24! ”</p>
                            </div>
                        </div>
                        <div class="swiper-slide h-auto">
                            <!-- Feedback-->
