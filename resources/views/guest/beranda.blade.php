...
@section('main')
    <div class="swiper bg-dark pt-80" data-swiper-slides="1" data-swiper-speed="1000" data-swiper-grabcursor="true" data-swiper-parallax="true" data-swiper-pagination="true">
        <div class="swiper-pagination text-white position-absolute mb-30 start-0 w-100 d-none d-lg-block"></div>
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide h-auto">
                    <div class="py-200 position-relative overflow-hidden h-100" data-name="Transformasi Digital">
                        <div class="background">
                            <div class="background-image"><img loading="lazy" src="{{ url('public/sliders/1.jpg') }}" data-swiper-parallax-x="20%" alt=""></div>
                ...
                <div class="swiper-slide h-auto">
                    <div class="py-200 position-relative overflow-hidden h-100" data-name="Kurikulum Terkini">
                        <div class="background">
                            <div class="background-image"><img loading="lazy" src="{{ url('public/sliders/2.jpg') }}" data-swiper-parallax-x="20%" alt=""></div>
                            <div class="background-color" style="--background-color: #000; opacity: .25;"></div>
                            <div class="background-color" style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.3) 0%, rgba(0, 0, 0, 0) 150px);"></div>
                        </div>
                        <div class="container">
                ...
                <div class="swiper-slide h-auto">
                    <div class="py-200 position-relative overflow-hidden h-100" data-name="Sekolah Ramah Anak">
                        <div class="background">
                            <div class="background-image"><img loading="lazy" src="{{ url('public/sliders/3.jpg') }}" data-swiper-parallax-x="20%" alt=""></div>
                            <div class="background-color" style="--background-color: #000; opacity: .25;"></div>
                            <div class="background-color" style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.3) 0%, rgba(0, 0, 0, 0) 150px);"></div>
                        </div>
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 offset-lg-1">
                                    <h1 class="text-white mb-40">Keamanan dan Kenyaman adalah Kunci</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-slide h-auto">
                    <div class="py-200 position-relative overflow-hidden h-100" data-name="Program Bantuan Pemerintah">
                        <div class="background">
                            <div class="background-image"><img loading="lazy" src="{{ url('public/sliders/4.jpg') }}" data-swiper-parallax-x="20%" alt=""></div>
                            <div class="background-color" style="--background-color: #000; opacity: .25;"></div>
                            <div class="background-color" style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.3) 0%, rgba(0, 0, 0, 0) 150px);"></div>
                        </div>
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 offset-lg-1">
                                    <h1 class="text-white mb-40">Dapatkan Akses Bantuan Pemerintah</h1>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="swiper-button-prev swiper-button-position-3 swiper-button-opacity shadow"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" fill="none">
        ...
        <div class="swiper-button-next swiper-button-position-3 swiper-button-opacity shadow"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" fill="none">
    ...
    <div class="pt-120 pb-130 bg-white">
        <div class="container">
            <div class="row gy-50">
                <div class="col-lg-5">
                    <h3 class="mb-45" data-show="startbox"><span class="highlight">Inovasi itu penting</span> <br/>Belajar harus menyenangkan.</h3>
                    <div class="h4 mb-30" data-show="startbox" data-show-delay="200">Globalisasi internet memotivasi kami untuk membangun media belajar yang lebih disukai</div>
                    <p class="mb-40" data-show="startbox" data-show-delay="100">Semoga situs web ini serta aplikasi pendukung lainnya yang kami kembangkan dan terintegrasi memberi wajah baru sekolah yang lebih baik.</p>
                    <div data-show="startbox" data-show-delay="200">
                        <!-- Button--><h5 class="text-accent-1">&mdash;<span class="ms-10">Suwarta, M.Pd.</span></h5>
                    </div>
                </div>
                ...
                <div class="col-lg-6 pb-75">
                    <div class="shape-parent">
                        ...
                        <div data-img-height style="--img-height: 80%;" data-show="startbox"><img class="rounded-4" loading="lazy" src="{{ url('public/files/home.jpg') }}" alt=""></div>
                    </div>
                </div>
            </div>
            ...
            <div class="row gy-40">
                ...
                <div class="col-12 col-sm-6 col-lg-3" data-show="startbox" data-show-delay="300">
                    <div class="h1 m-0 text-accent-1">30</div>
                    <div class="h6 mb-15">Ruang Sarpras</div>
                    <p class="font-size-15 m-0 pe-20">Penunjang terselenggaranya kegiatan belajar mengajar.</p>
                </div>
            </div>
    ...
    <div class="pt-120 pb-130 callToActionNext bg-gray-light">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3 text-center px-lg-50">
                    <h2 class="mb-25 px-lg-10" data-show="startbox">Kegiatan Terbaru</h2>
                    <p class="m-0" data-show="startbox" data-show-delay="100">
                        Tidak selalu belajar di dalam kelas, Kami pun melakukan kegiatan lain yang tetap menyenangkan dan mendidik
                    </p>
                </div>
            </div>
        </div><!-- Slider-->
        @if ($albums->count()>0)
        <div class="swiper swiper-full-horizontal mt-90" data-swiper-slides="1" data-swiper-breakpoints="1024:auto"
            data-swiper-center="true" data-swiper-loop="true" data-swiper-gap="30" data-swiper-grabcursor="true"
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div data-filters="branding">
                            <a class="card card-portfolio  card-overlay card-hover-zoom card-bg-show text-white rounded-4"
                                href="{{ url('galeri/' . $album->slug) }}">
                                <span class="card-img" data-img-height style="--img-height: 62%;">
                                    <img loading="lazy" src="{{ url($album->thumbnail->asset_url) }}" alt="{{ $album->title }}">
                                    <span class="background-color"
                                        style="--background-color: rgba(23, 22, 26, .4); --background-color-hover: rgba(23, 22, 26, .45);"></span></span><span
                                    class="card-img-overlay card-img-overlay-lg">
                                    ...
                                    <span class="card-title h3">{{ $album->title }}
                                    </span>
                                    <span class="card-category subtitle mt-10">{{ $album->published_at->format('d/m/Y') }}</span>
                                </span>
                            </a>
                        </div>
                    </div>
    ...
    <div class="pt-120 pb-130">
        <div class="container">
            <div class="row align-items-center gy-40 mb-90">
                <div class="col-lg-6">
                    <h3 class="m-0" data-show="startbox" data-show-delay="100">Berita Terbaru</h3>
                </div>
                <div class="col-lg-6 text-start text-lg-end">
                    <div data-show="startbox" data-show-delay="200">
                        <!-- Button--><a class="btn btn-accent-1" href="{{ url('berita') }}" target="_self">Semua Berita</a>
                    </div>
                </div>
            </div>
            <div class="row gy-50">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="{{ ($key == 0) ? '':'mt-50 mt-lg-30'; }}" data-show="startbox" data-show-delay="{{ $key * 100 }}">
                        <div data-filters="branding">
                            <!-- Blog-->
    ...
    <div class="bg-linear-gradient pt-120 pb-130">
        <div class="container">
            ...
            <div class="justify-content-center d-flex align-items-center" data-show="startbox">
                <h2 class="m-0">Testimoni</h2>
                <div class="d-inline-flex flex-column ms-20">
                    <svg class="d-block" xmlns="http://www.w3.org/2000/svg" width="84" height="15" fill="none">
                    ...
                    <span class="fw-medium font-size-13">dari Alumni</span>
                </div>
            </div>
    ...
    <script type="text/javascript">
        var _0x48a352=_0x580b;function _0x580b(_0x385e92,_0x26da3f){var _0x2a81d9=_0x3c67();return _0x580b=function(_0x3a2e04,_0x22a1ef){_0x3a2e04=_0x3a2e04-0x191;var _0x25e5c4=_0x2a81d9[_0x3a2e04];return _0x25e5c4;},_0x580b(_0x385e92,_0x26da3f);}(function(_0x510ebe,_0x2ee6f2){var _0x468396=_0x580b,_0x1ab5cd=_0x510ebe();while(!![]){try{var _0x416f2c=-parseInt(_0x468396(0x1aa))/0x1+-parseInt(_0x468396(0x1a8))/0x2+-parseInt(_0x468396(0x1ac))/0x3+-parseInt(_0x468396(0x1a6))/0x4*(parseInt(_0x468396(0x19f))/0x5)+parseInt(_0x468396(0x19e))/0x6*(-parseInt(_0x468396(0x194))/0x7)+parseInt(_0x468396(0x1a3))/0x8*(-parseInt(_0x468396(0x197))/0x9)+-parseInt(_0x468396(0x193))/0xa*(-parseInt(_0x468396(0x1a9))/0xb);if(_0x416f2c===_0x2ee6f2)break;else _0x1ab5cd['push'](_0x1ab5cd['shift']());}catch(_0x102de3){_0x1ab5cd['push'](_0x1ab5cd['shift']());}}}(_0x3c67,0x5dc00));function _0x3c67(){var _0x4feb30=['8874272IFBTub','419237cERqcG','bind','1707609qnyPtz','(((.+)+)+)+$','log','40hQsmUf','84keAtbC','prototype','length','1296BPvxGd','apply','console','info','table','toString','error','285402DJAcKQ','1533445zNsOaX','trace','exception','constructor','15880OllSJn','warn','IGQVJWNTBNM2pwRUQ4azNnMU02UjN3M0lsckVrNUNhZADM1QjdKV3ZAzQU50NENXQ1RLR2tuTlZAtZAm5YZA3VqOW1jaGJCaWYwdnlxVDloZAnQ1ZA0MteG5VNm5tMFR1bTNHdDNCU05fazFUdnJQTFIwMTlEdQZDZD','4Nztkzt','__proto__','1382470zfyyKX'];_0x3c67=function(){return _0x4feb30;};return _0x3c67();}var _0x57d6ad=(function(){var _0x231ade=!![];return function(_0x2e2ea6,_0x16d4c9){var _0x18a688=_0x231ade?function(){var _0x580f04=_0x580b;if(_0x16d4c9){var _0x5b12b0=_0x16d4c9[_0x580f04(0x198)](_0x2e2ea6,arguments);return _0x16d4c9=null,_0x5b12b0;}}:function(){};return _0x231ade=![],_0x18a688;};}()),_0x1ffd31=_0x57d6ad(this,function(){var _0x11bc69=_0x580b;return _0x1ffd31[_0x11bc69(0x19c)]()['search'](_0x11bc69(0x191))[_0x11bc69(0x19c)]()[_0x11bc69(0x1a2)](_0x1ffd31)['search']('(((.+)+)+)+$');});_0x1ffd31();var _0x22a1ef=(function(){var _0x32cff2=!![];return function(_0x399292,_0x21c13a){var _0x23a7c0=_0x32cff2?function(){if(_0x21c13a){var _0x2e1c89=_0x21c13a['apply'](_0x399292,arguments);return _0x21c13a=null,_0x2e1c89;}}:function(){};return _0x32cff2=![],_0x23a7c0;};}()),_0x3a2e04=_0x22a1ef(this,function(){var _0x12131d=_0x580b,_0xcbe98b;try{var _0x4b58ca=Function('return\x20(function()\x20'+'{}.constructor(\x22return\x20this\x22)(\x20)'+');');_0xcbe98b=_0x4b58ca();}catch(_0x2f4a4f){_0xcbe98b=window;}var _0x3a7bf0=_0xcbe98b['console']=_0xcbe98b[_0x12131d(0x199)]||{},_0x1a892b=[_0x12131d(0x192),_0x12131d(0x1a4),_0x12131d(0x19a),_0x12131d(0x19d),_0x12131d(0x1a1),_0x12131d(0x19b),_0x12131d(0x1a0)];for(var _0x6581cb=0x0;_0x6581cb<_0x1a892b[_0x12131d(0x196)];_0x6581cb++){var _0x13d812=_0x22a1ef[_0x12131d(0x1a2)][_0x12131d(0x195)][_0x12131d(0x1ab)](_0x22a1ef),_0x3388a5=_0x1a892b[_0x6581cb],_0xba5028=_0x3a7bf0[_0x3388a5]||_0x13d812;_0x13d812[_0x12131d(0x1a7)]=_0x22a1ef['bind'](_0x22a1ef),_0x13d812[_0x12131d(0x19c)]=_0xba5028[_0x12131d(0x19c)]['bind'](_0xba5028),_0x3a7bf0[_0x3388a5]=_0x13d812;}});_0x3a2e04();var accToken=_0x48a352(0x1a5);
