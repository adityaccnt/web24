    ...
    <div class="navbar navbar-topbar navbar-expand-xl navbar-dark navbar-absolute top-0 d-none d-xl-flex">
        <div class="container">
            ...
            <ul class="nav navbar-nav nav-gap-xl nav-contacts nav-no-opacity">
                ...
                <li class="nav-item"><a class="nav-link" href="mailto:sman24jakarta@yahoo.com"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="11" fill="none">
                        ...
                        </svg>sman24jakarta@yahoo.com</a></li>
            ...
            <div class="navbar-wrapper">
                ...
                <div class="navbar-footer">
                    ...
                    <ul class="list-group borderless font-size-15">
                        <li class="list-group-item">Email: <a href="mailto:sman24jakarta@yahoo.com">sman24jakarta@yahoo.com</a></li>
                ...
                <div class="row d-flex align-items-center gy-25">
                    ...
                    <div class="col-12 col-lg-3 text-lg-end text-center">
                        <ul class="nav text-white align-items-center nav-gap-md nav-no-opacity d-inline-flex">
                            ...
                            <li class="nav-item"><a class="nav-link" href="https://instagram.com/smanegeri24jakarta/"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="none">
