...
@section('main')
    ...
    <div class="content-wrap ">
        ...
        <div class="position-relative py-210">
            ...
            <div class="container">
                <h1 class="text-white mb-0 text-center">{{ $organization->name }}</h1>
            </div>
        </div>
        ...
        <div class="bg-linear-gradient py-120 footerPrev">
            <div class="container">
                <h2 class="text-center" data-show="startbox">Ekstrakurikuler Lainnya</h2><!-- Slider-->
                <div class="swiper my-90" data-swiper-slides="1" data-swiper-breakpoints="828:2, 1024:3" data-swiper-gap="30" data-swiper-grabcursor="true" data-show="startbox" data-show-delay="100">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div data-filters="marketing">
                                    <!-- Portfolio-->
                                    <a class="card card-portfolio  card-overlay card-hover-appearance text-white text-center rounded-4" href="{{ url('osis/' . $organization->slug) }}">
                                        <span class="card-img" data-img-height style="--img-height: 92%;">
                                        <img loading="lazy" src="{{ url($organization->logo->asset_url) }}" alt="">
                                        <span class="background-color" style="--background-color: rgba(240, 31, 75, 0.9);"></span>
                                    </span>
                                    <span class="card-img-overlay">
                                        <span class="card-title h4">{{ $organization->name }}</span>
                                    </span>
                                </a>
                                </div>
                            </div>
