    ...
    <div class="content-wrap ">
        ...
        <div class="position-relative py-210">
            <div class="background">
                <div class="background-image jarallax" data-jarallax data-speed="0.8"><img class="jarallax-img" loading="lazy" src="{{ url('public/files/kontak.jpg') }}" alt=""></div>
                <div class="background-color" style="--background-color: #000; opacity: .25;"></div>
            </div>
            <div class="container">
                <h1 class="text-white mb-0 text-center">Hubungi Kami</h1>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row gy-50">
                    <div class="col-lg-4">
                        ...
                        <div class="d-flex mt-50" data-show="startbox" data-show-delay="100">
                            ...
                            <div class="flex-grow-1 ms-15">
                                ...
                                <p class="m-0 mt-15">Jalan Lapangan Tembak Nomor 1, <br>Kel. Gelora, Kec. Tanah Abang <br/> Kota Jakarta Pusat 10270</p>
                            </div>
                        </div><!-- Item-->
                        <div class="d-flex mt-50" data-show="startbox" data-show-delay="200">
                            ...
                            <div class="flex-grow-1 ms-15">
                                <h5 class="m-0">Jam Layanan:</h5>
                                <p class="m-0 mt-15">Senin - Jumat <br>08:00 - 15:00 WIB</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8" data-show="startbox" data-show-delay="300">
                        ...
                        <form>
                            <div class="row gy-40">
                                <div class="col-12 col-md-6"><input class="form-control" type="text" placeholder="Nama *"></div>
                                <div class="col-12 col-md-6"><input class="form-control" type="email" placeholder="Email *"></div>
                                <div class="col-12 col-md-6"><input class="form-control" type="tel" placeholder="Telepon *"></div>
                                ...
                                {{-- <div class="col-12 col-md-6 col-lg-5">
                                    <div class="form-attach-file"><label class="form-attach-label" for="formFile"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="26" fill="none">
                                            ...
                                            </svg>Lampiran</label><input class="form-control" type="file" id="formFile" hidden></div>
                                </div> --}}
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="form-check"><input class="form-check-input" type="checkbox" value="" id="personalData"><label class="form-check-label" for="personalData">Saya setuju menggunakan data pribadi untuk diproses *</label></div>
                                </div>
                                <div class="col-12 col-lg-3 text-start text-lg-end">
                                    <!-- Button--><button class="btn btn-secondary" disabled>Kirim</button>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <div class="position-relative">
            <div class="half-section-block container position-absolute top-50 start-0 end-0" data-prev-id=".footerPrev" data-next-id=".footerNext">
                <div class="shape-parent">
                    ...
                    <div class="map-container bg-dark rounded-4 overflow-hidden" style="height: 506px;"><iframe src="https://maps.google.com/maps?q=sman24jakarta&amp;t=&amp;z=13&amp;ie=UTF8&amp;iwloc=&amp;output=embed" allowfullscreen style="border: 0px;"></iframe></div>
                </div>
            </div>
        </div>
    </div>
