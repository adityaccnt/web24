...
@section('main')
    <div class="card card-raised">
        <div class="card-body p-5">
            ...
            <p>Setiap melakukan perubahan nilai, tekan tombol <b>Simpan</b> pada bagian bawah untuk menyimpan perubahan. Jika
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="form-select px-2" name="sikap[]" style="width: 8ch" required>
                                        <option value=""></option>
                                        <option value="A" @if ($score->sikap && $score->sikap == 'A') selected @endif>A</option>
