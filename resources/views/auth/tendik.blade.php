...
@section('main')
    <div class="card card-raised">
        <div class="card-body p-5">
            ...
            <div class="display-6">Tenaga Kependidikan</div>
            <p class="card-text">Menampilkan semua daftar Tenaga Kependidikan serta informasi mengenai Tenaga Kependidikan tersebut.</p>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ url('kelola-tendik/' . $user->id .'/edit') }}" class="me-2"><span class="material-icons">edit</span></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
