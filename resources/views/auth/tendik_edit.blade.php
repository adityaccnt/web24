...
<div class="mb-5 col-lg-9">
    <div class="card card-raised">
        <div class="card-body p-5">
            <form enctype="multipart/form-data" action="{{ url('kelola-tendik/' . $user->id) }}" method="POST">
                @csrf
                @method('patch')
                <div class="row">
                    ...
                    {{-- <div class="mb-4 col-12 col-sm-3">
                        <label class="form-label mb-2 text-muted" for="position">Tugas <span class="text-danger">*</span></label>
                        <input class="form-control" id="position" name="position" value="{{ old('position', $user->position->title) }}" type="text" required>
                    </div> --}}
                </div>
