...
@section('main')
    <div class="card card-raised">
        <div class="card-body p-5">
            ...
            <div class="display-6">Manajemen</div>
            <p class="card-text">Menampilkan semua daftar manajemen serta informasi mengenai manajemen tersebut.</p>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ url('kelola-manajemen/' . $user->id .'/edit') }}" class="me-2"><span class="material-icons">edit</span></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
